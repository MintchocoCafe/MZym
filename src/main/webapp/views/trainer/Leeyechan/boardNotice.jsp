    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-create" style="border: inset;">
                ...
                <button type="button" style="margin-right: 10px;" class="close" data-dismiss="modal">&times;</button>
                </div>
                <br>
                <form action="<%=mzymPath%>/insertNotice.trainer" method="post" enctype="multipart/form-data">
	                <!-- Modal body -->
	                <div class="modal-body-create" style="border: inset; margin: 10px; padding: 10px;">
	                    <div class="hair-careate" style="width: 95%;"><input style="border: 0; width: 100%; margin-top: 10px; margin-bottom: 10px;" name='title' type="text" placeholder="제목 입력"></div>
